...
# TODO: Break up legislator documents so that sub document are other collections. Write performance.
                        ...
                        db.legislator_sponsored.insert(
                            {
                                ...
                                "title": bill.get("official_title", "NO TITLE") # make a function that gets on of the titles
                            }
                        )
